import schoolLogo from '../assets/rs-school-logo.svg';
  ...
  return (
    <footer className="page-footer">
      <a
        ...
        aria-label="KateKaliaha on GitHub"
        target="_blank"
        rel="noreferrer"
      >
        <svg width="36" height="36" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false">
      ...
      <a
        ...
        href="https://github.com/rolling-scopes-school/tasks/tree/master/fullstack-engineering"
        aria-label="RS School — Fullstack Engineering course"
        target="_blank"
        rel="noreferrer"
      >
        <img src={schoolLogo} alt="RS School" width="108" height="40" />
      </a>
    </footer>
  );
}
