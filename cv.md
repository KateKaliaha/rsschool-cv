...
- Phone: [+375 (29) 325-79-35](tel:+375293257935)
- Email: [kolagaekaterina@gmail.com](mailto:kolagaekaterina@gmail.com)
- GitHub: [KateKaliaha](https://github.com/KateKaliaha/)
- LinkedIn: [katekaliaha](https://www.linkedin.com/in/katekaliaha/)
- Discord: katekaliaha

## About Me

React Native / Frontend Developer with commercial experience since 2022. I develop and release iOS, Android, and web applications, integrate native functionality, and implement payment and subscription flows. My experience includes coordinating frontend developers, conducting code reviews, and planning releases. I am currently expanding my backend knowledge to transition into fullstack development.

## Skills

- **Languages:** JavaScript, TypeScript; Swift for iOS widget development.
- **Frontend:** HTML, CSS, React, Vite, PWA, Canvas API.
- **State Management:** Zustand, Redux, MobX.
- **Mobile:** React Native, React Navigation, React Native Reanimated, Cordova, Deep Linking, Push Notifications, Unity integration.
- **APIs & Data:** REST API, WebSocket, IndexedDB, GPT API integration.
- **Payments & Subscriptions:** In-App Purchases, Subscriptions, Stripe, Recurly, Solidgate, TrueGate, Apple Pay, Google Pay.
- **Analytics & Monetization:** Firebase, Mixpanel, Facebook SDK, AppLovin.
- **Localization & Product Experiments:** i18next, Remote Config, A/B Testing.
- **Development & Delivery:** Git, Xcode, Android Studio, CI/CD, AWS S3, TestFlight, App Store Connect, Google Play Console.
- **AI Coding Tools:** Codex, Claude Code.
- **Team Leadership:** Code Review, Task and Release Planning, Frontend Team Coordination, 1:1s, Performance Reviews.

## Work Experience

### React Native / Frontend Developer — WannaPlay
...
### React Native Developer — Tactil LLC
...
### Frontend Developer — NostrCorp, Inc.
